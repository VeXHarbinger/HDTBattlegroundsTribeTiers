...
namespace HDTBattlegroundsTribeTiers.Logic
{
    /// <summary>
    ...
    public class InputMoveManager
    {
        ...
        private RacesDisplayControl _Control;
        ...
        public InputMoveManager(RacesDisplayControl panel)
        {
            _Control = panel;
        }
        ...
        private void MouseInputOnLmbDown(object sender, EventArgs eventArgs)
        {
            ...
            if (PointInsideControl(_mousePos, _Control))
            {
                _selected = true;
            }
            else
        ...
        private void MouseInputOnMouseMoved(object sender, EventArgs eventArgs)
        {
            ...
            if (pos.X > Core.OverlayCanvas.Width)
            {
                Canvas.SetLeft(_Control, p.X);
            }
            if (pos.Y > Core.OverlayCanvas.Height)
            {
                Canvas.SetTop(_Control, p.Y);
            }
        }
